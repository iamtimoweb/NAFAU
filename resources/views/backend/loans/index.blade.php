                    ...
                    <div class="card">
                        @can('create-loan')
                            <div class="card-header">
                                <a href="{{route('backend.loans.create')}}"
                        ...
                        @endcan
                        <div class="card-body">
                            <table id="tbl-loans" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>Farmer</th>
    ...
    <script>
        $(function () {
            ...
            $("#tbl-loans").DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('backend.loans.index') !!}',
                columns: [
        ...
        $('#tbl-loans').on('click', '.btn-delete-loan[data-remote]', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        $('#tbl-loans').DataTable().draw(false);
                        Swal.fire(
                            'Success!',
