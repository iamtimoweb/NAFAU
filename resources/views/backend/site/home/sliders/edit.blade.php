...
<!-- Page title -->
@section('pageTitle') edit slider @endsection
@section('styles')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-default">
                        <form id="updateSliderForm" action="{{route('backend.sliders.update', $slider->id)}}"
                              method="POST"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title"
                                               ...
                                               id="title" value="{{ $slider->title }}" placeholder="title...">
                                        @error('title')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" name="image" accept=".jpeg, .jpg, .png"
                                                   ...
                                                   id="image">
                                            <label class="custom-file-label" for="image">Select image or leave blank</label>
                                            @error('image')
                                            <div class="invalid-tooltip" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="icheck-primary">
                                            <input type="checkbox" name="is_active" id="is_active"
                                                   @if($slider->is_active) checked @endif>
                                            <label for="is_active">
                                                Is Active
                                            </label>
                                        </div>
