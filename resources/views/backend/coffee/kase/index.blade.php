...
@section('pageTitle') kase @endsection
@section('styles')
    <!-- DataTables -->
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Kase</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        @can('create-coffee')
                            <div class="card-header">
                                <a href="{{route('backend.kase.create')}}"
                        ...
                        @endcan
                        <div class="card-body">
                            <table id="tbl-kase" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>Image</th>
    ...
    <script>
        $(function () {
            ...
            $("#tbl-kase").DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('backend.kase.index') !!}',
                columns: [
                    {data: 'date', name: 'date'},
                    {data: 'image', name: 'image'},
                    {data: 'farmer', name: 'farmer'},
                    {data: 'kase_kgs', name: 'kase_kgs'},
                    {data: 'cutting', name: 'cutting'},
                    {data: 'price', name: 'price'},
                    {data: 'milling_charges', name: 'milling_charges'},
        ...
        $('#tbl-kase').on('click', '.btn-delete-kase-coffee[data-remote]', function (e) {
            e.preventDefault();
