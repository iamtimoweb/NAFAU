...
<!-- Page title -->
@section('pageTitle') create kase @endsection
@section('styles')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline shadow">
                        <form id="createkaseForm" action="{{route('backend.kase.store')}}" method="POST"
                              enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Create Kase Coffee Entity
                                </h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" name="kase_kgs"
                                               ...
                                               id="kase_kgs" value="{{ old('kase_kgs') }}"
                                               placeholder="Kase...">
                                        @error('kase_kgs')
                                        <span class="invalid-tooltip" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" name="milling_charges"
                                               class="form-control @error('price') is-invalid @enderror"
                                               id="pmilling_chargesrice" value="{{ old('milling_charges') }}"
