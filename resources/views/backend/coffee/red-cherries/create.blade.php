...
<!-- Page title -->
@section('pageTitle') create red-cherries @endsection
@section('styles')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline shadow">
                        <form id="createRedCherriesForm" action="{{route('backend.red-cherries.store')}}" method="POST"
                              enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Create Red Cherries Coffee Entity
                                </h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" name="red_cherries_kgs"
                                               ...
                                               id="red_cherries_kgs" value="{{ old('red_cherries_kgs') }}"
