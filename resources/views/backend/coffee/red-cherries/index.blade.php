            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Red Cherries</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        @can('create-coffee')
                            <div class="card-header">
                                <a href="{{route('backend.red-cherries.create')}}"
                        ...
                        @endcan
                        <div class="card-body">
                            <table id="tbl-red-cherries" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Date</th>
                                    <th>Image</th>
                                    <th>Farmer</th>
                                    <th>Red Cherries (kgs)</th>
                                    <th>Price</th>
                                    <th>Amount</th>
                                    <th>Reason</th>
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $("#tbl-red-cherries").DataTable({
                "responsive": true,
                "autoWidth": false,
                processing: true,
                serverSide: true,
                ajax: '{!! route('backend.red-cherries.index') !!}',
                columns: [
                    {data: 'date', name: 'date'},
                    {data: 'image', name: 'image'},
                    {data: 'farmer', name: 'farmer'},
                    {data: 'red_cherries_kgs', name: 'red_cherries_kgs'},
        ...
        $('#tbl-red-cherries').on('click', '.btn-delete-red-cherries-coffee[data-remote]', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        $('#tbl-red-cherries').DataTable().draw(false);
                        Swal.fire(
                            'Success!',
